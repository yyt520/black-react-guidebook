...
> 了解更多关于 [Location 对象](https://yyt520.github.io/javascript-guidebook/browser-object-model/window/location)
...
> 具体实现方式和 API 参数参阅 [History 对象的方法](https://yyt520.github.io/javascript-guidebook/browser-object-model/window/history)
